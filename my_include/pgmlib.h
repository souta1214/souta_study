...
#define GRAYLEVEL            256 /* 想定する階調数（＝最大階調値＋１） */
#define MAX_FILENAME         256 /* 想定するファイル名の最大長 */
#define MAX_BUFFERSIZE       256 /* 利用するバッファの最大長 */
#define MAX_NUM_OF_IMAGES      5 /* 利用する画素の枚数 */
...
/* 階調画像を初期化する関数*/
void init_image( int n, unsigned char value )
/* 画像No.nの全画像の階調値を強制的にvalue(0～255)にする */
{
    int x, y; /* ループ変数 */
